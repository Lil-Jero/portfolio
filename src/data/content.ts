export type SectionId = 'hero' | 'experience' | 'expertise' | 'projets' | 'contact'
...
// TODO: remplacer par le CV définitif déposé dans public/.
export const CV_URL = '/cv.pdf'

export const HERO = {
  eyebrow: 'Frontend Developer · Vue.js 3',
  title: 'Je façonne des interfaces Vue.js cohérentes, du design system au dernier pixel.',
...
export const DESIGN_SYSTEM_HIGHLIGHTS: DesignSystemHighlight[] = [
  { value: '~30 composants', description: 'documentés et versionnés dans Storybook' },
  { value: '3 devs', description: 'accompagnés — 2 nouveaux arrivants, 1 reconversion vers le front' },
]
...
// TODO: remplacer les url par les publications LinkedIn réelles et valider les accroches.
...
export const FEATURED_PROJECT = {
  ...
  description: '[Une phrase sur ce que fait le projet et pourquoi tu l’as construit.]',
...
export const EXPLORATIONS: Exploration[] = [
  {
    ...
    nextStep: 'Prochaine étape : 5 à 8 entretiens coachs pour valider le besoin avant la première ligne de code.',
  },
  {
    ...
    fact: { label: 'Cible offre', value: 'coachs indépendants (auto-entrepreneurs)' },
    nextStep: 'Piste de différenciation : la carte professionnelle comme signal de confiance.',
  },
]

// TODO: renseigner l'adresse email, le profil LinkedIn et le lien du CV.
export const CONTACT = {
  eyebrow: 'Contact',
  title: 'On construit quelque chose ensemble ?',
  lead: 'Ouvert aux opportunités à Toulouse et ses environs, ou en full remote partout en Europe.',
  email: '[ton.email@exemple.com]',
  emailUrl: 'mailto:[ton.email@exemple.com]',
  linkedinLabel: 'linkedin.com/in/[ton-profil]',
